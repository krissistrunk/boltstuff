...
export function ScenarioForm() {
  ...
  const addQuestion = () => {
    if (!currentQuestion.question.trim() || !currentQuestion.scenario.trim()) {
      toast({
        title: "Error",
        description: "Please enter both question and scenario",
        variant: "destructive",
      });
      return;
    }
    ...
    const emptySubQuestions = currentQuestion.questions.some(
      q => !q.question.trim() || !q.explanation.trim() || q.options.some(opt => !opt.trim())
    );
    if (emptySubQuestions) {
      toast({
        title: "Error",
        description: "Please fill in all sub-questions, options, and explanations",
        variant: "destructive",
      });
      return;
    }
                ...
                <Card key={index} className="p-4">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="mt-2 bg-secondary/50 p-4 rounded-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setCurrentQuestion({ ...currentQuestion, scenario: e.target.value })}
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <Textarea
                              ...
                              onChange={(e) => updateSubQuestion(questionIndex, "explanation", e.target.value)}
